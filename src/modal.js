...
export const createModal = function() {
    ...
    modal.innerHTML = ` <button class="close">
                        ...
                        <div class="date"></div>
                        <form>
                            <div class="subject"><input type="text" placeholder="write the subject of the task"></div>
                            <div class="description"><textarea placeholder="write the details of this task"></textarea></div>
